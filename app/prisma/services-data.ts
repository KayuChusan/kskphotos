...
export const SERVICES = [
  { id: "seed-svc-photo", title: "出張撮影（時間制）", description: "ポートレート・ファミリー・イベントなど。用途を問わず時間制で承ります。", price: 0, priceNote: "時間制 1時間 ¥14,000〜", duration: "時間制", category: "PORTRAIT" as const, isPopular: false, features: ["1時間 ¥14,000（30分延長ごとに +¥7,000）", "半日4時間 ¥44,000／1日8時間 ¥78,000（長いほど時間割安）", "撮影時間に応じたセレクト納品（1時間あたり約20枚）", "うちレタッチ仕上げは撮影1時間につき10枚込み", "レタッチ追加 1枚 ¥1,000（10枚パック ¥8,000）", "出張費は別途実費"], sortOrder: 1 },
  ...
  { id: "seed-svc-web", title: "サイト制作", description: "構成からデザイン・実装・公開まで一括対応。", price: 128000, priceNote: "〜", duration: "LP・ポートフォリオ・予約サイト", category: "WEB_PRODUCTION" as const, isPopular: false, features: ["構成・デザイン・実装・公開まで一括", "スマホ対応・高速表示", "独自ドメイン・SSL 設定込み", "予約フォーム・ギャラリー組み込み対応", "公開後の更新方法もレクチャー", "運用へ移行する場合、最初の3ヶ月は運用サポート無償（軽微な更新・修正を月2回まで）", "規模により変動。ページ数・機能・作り込みの範囲で変わり、多機能サイトは ¥248,000〜目安"], sortOrder: 4 },
  ...
  { id: "seed-svc-maint", title: "保守・運用サポート", description: "サイトの更新・管理・障害一次対応。", price: 11000, priceNote: "〜", duration: "月額・継続契約", category: "IT_SUPPORT" as const, isPopular: false, features: ["当社制作サイトは制作から運用移行で最初の3ヶ月無償（軽微な更新・修正を月2回まで／新規ページ追加・デザイン刷新・機能追加は別途）", "サイトの更新作業・軽微な修正", "ドメイン・サーバー・SSL の管理", "障害時の一次対応（即応保証（SLA）はなく、営業時間内のベストエフォート対応）", "アクセス状況の簡易レポート", "メール・ツールの困りごと相談"], sortOrder: 6 },
  { id: "seed-svc-it", title: "ドメイン・メール・IT の初期構築", description: "独自ドメイン取得・ドメインメール・Google Workspace / Microsoft 365 の初期構築とスポット相談。", price: 0, priceNote: "初期 ¥40,000〜／スポット ¥12,000/時（要見積）", duration: "初期構築＋スポット", category: "IT_SUPPORT" as const, isPopular: false, features: ["独自ドメイン取得代行（実費＋手数料）", "ドメインメール（DNS/MX）の設定・移行", "Google Workspace / Microsoft 365 の導入・初期設定", "設定手順のドキュメントを納品（お客様がすべて所有）", "ライセンスはお客様名義で直接契約（当方は再販しません）", "運用管理はお客様保有・即応保証（SLA）なし・スポット相談で対応"], sortOrder: 7 },
];
