...
export const SERVICES = [
  { id: "seed-svc-photo", title: "出張撮影（時間制）", description: "ポートレート・ファミリー・イベントなど。用途を問わず時間制で承ります。", price: 0, priceNote: "時間制 1時間 ¥11,000〜", duration: "時間制", category: "PORTRAIT" as const, isPopular: false, features: ["1時間 ¥11,000（30分延長ごとに +¥5,000）", "撮影した全カットのデータ納品込み", "レタッチ仕上げは撮影1時間につき10枚込み", "レタッチ追加 1枚 ¥1,000（10枚パック ¥8,000）", "出張費は別途実費"], sortOrder: 1 },
  ...
  { id: "seed-svc-web", title: "サイト制作", description: "構成からデザイン・実装・公開まで一括対応。", price: 88000, priceNote: "〜", duration: "LP・ポートフォリオ・予約サイト", category: "WEB_PRODUCTION" as const, isPopular: false, features: ["構成・デザイン・実装・公開まで一括", "スマホ対応・高速表示", "独自ドメイン・SSL 設定込み", "予約フォーム・ギャラリー組み込み対応", "公開後の更新方法もレクチャー"], sortOrder: 4 },
  ...
  { id: "seed-svc-maint", title: "保守・運用サポート", description: "サイトの更新・管理・障害一次対応。", price: 11000, priceNote: "〜", duration: "月額・継続契約", category: "IT_SUPPORT" as const, isPopular: false, features: ["サイトの更新作業・軽微な修正", "ドメイン・サーバー・SSL の管理", "障害時の一次対応", "アクセス状況の簡易レポート", "メール・ツールの困りごと相談"], sortOrder: 6 },
