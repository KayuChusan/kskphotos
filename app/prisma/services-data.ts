...
export const SERVICES = [
  ...
  { id: "seed-svc-it", title: "ドメイン・メール・IT の初期構築", description: "独自ドメイン取得・ドメインメール・Google Workspace / Microsoft 365 の初期構築とスポット相談。", price: 0, priceNote: "初期 ¥40,000〜／スポット ¥12,000/時（要見積）", duration: "初期構築＋スポット", category: "IT_SUPPORT" as const, isPopular: false, features: ["独自ドメイン取得代行（実費＋手数料）", "ドメインメール（DNS/MX）の設定・移行", "Google Workspace / Microsoft 365 の導入・初期設定", "設定手順のドキュメントを納品", "スポット相談での運用サポート"], sortOrder: 7 },
];
