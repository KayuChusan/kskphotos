...
export const SERVICES = [
  { id: "seed-svc-photo", title: "出張撮影（時間制）", description: "ポートレート・ファミリー・イベントなど。用途を問わず時間制で承ります。", price: 0, priceNote: "時間制 1時間 ¥14,000〜", duration: "時間制", category: "PORTRAIT" as const, isPopular: false, features: ["1時間 ¥14,000（30分延長ごとに +¥6,000）", "撮影時間に応じたセレクト納品（1時間あたり約20枚）", "うちレタッチ仕上げは撮影1時間につき10枚込み", "レタッチ追加 1枚 ¥1,000（10枚パック ¥8,000）", "出張費は別途実費"], sortOrder: 1 },
