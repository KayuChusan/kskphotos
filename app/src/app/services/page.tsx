...
export const metadata: Metadata = {
  ...
  title: "料金・メニュー",
  description:
    "撮影料金 — 時間制で明朗会計。1時間 ¥14,000、撮影時間に応じてセレクト納品（1時間あたり約20枚）。Web 制作は規模別（¥128,000〜、作り込み・候補者/法人は¥248,000〜目安）。料金の考え方と各サービスの案内も掲載。",
};
...
const RATE_TABLE = [
  { time: "1時間", price: "¥14,000", deliver: "約20枚", retouch: "10枚", note: "プロフィール・宣材1カット" },
  { time: "2時間", price: "¥26,000", deliver: "約40枚", retouch: "20枚", note: "ファミリー・カップル" },
  { time: "半日（4時間）", price: "¥50,000", deliver: "約80枚", retouch: "40枚", note: "イベント・選挙ポスター撮影" },
  { time: "1日（8時間）", price: "¥98,000", deliver: "約160枚", retouch: "80枚", note: "終日イベント・密着" },
];
...
// オプション・追加料金
const ADDONS = [
  { label: "撮影時間の延長", price: "30分ごと +¥6,000（込みレタッチも比例で増加）" },
...
const PRICING_POLICY = [
  ...
  },
  {
    icon: Globe,
    title: "Web は規模別",
    body: "¥128,000〜が目安。テンプレート流用の格安制作（数万円）とは品質カテゴリが別です。作り込み・候補者/法人サイトは ¥248,000〜が目安。",
  },
  {
    icon: Layers,
    title: "まとめてお得",
          ...
          <div className="mb-8 text-center">
            ...
            <p className="mx-auto mt-3 max-w-2xl text-sm leading-relaxed text-muted-foreground">
              <JaText>
                ...
                サイト制作は規模により異なります（¥128,000〜、作り込み・候補者/法人サイトは ¥248,000〜目安）。
              </JaText>
            </p>
          </div>
          <div className="grid gap-6 md:grid-cols-3">
