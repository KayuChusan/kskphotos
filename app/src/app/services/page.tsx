...
export const metadata: Metadata = {
  ...
  title: "料金・メニュー",
  description:
    "撮影料金 — 時間制で明朗会計。1時間 ¥14,000、撮影時間に応じてセレクト納品（1時間あたり約20枚）。Web 制作は規模別（¥128,000〜、多機能・作り込みは¥248,000〜目安）。料金の考え方と各サービスの案内も掲載。",
};
...
const RATE_TABLE = [
  ...
  { time: "半日（4時間）", price: "¥44,000", deliver: "約80枚", retouch: "40枚", note: "イベント・選挙ポスター撮影" },
  { time: "1日（8時間）", price: "¥78,000", deliver: "約160枚", retouch: "80枚", note: "終日イベント・密着" },
];
...
// オプション・追加料金
const ADDONS = [
  { label: "撮影時間の延長", price: "30分ごと +¥7,000（当日延長は時間割安の対象外／込みレタッチは比例で増加）" },
...
const PRICING_POLICY = [
  ...
  },
  {
    icon: Globe,
    title: "Web は規模別",
    body: "¥128,000〜が目安。テンプレート流用の格安制作（数万円）とは品質カテゴリが別です。ページ数・機能・公選法表示対応など作り込みの範囲で変わり、多機能サイトは ¥248,000〜が目安。",
  },
  {
    icon: Layers,
    title: "まとめてお得",
